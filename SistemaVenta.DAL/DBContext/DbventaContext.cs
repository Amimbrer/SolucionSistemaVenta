...
namespace SistemaVenta.Dak.DbContext;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ALBERTO\\SQLEXPRESS; DataBase=DBVENTA;User Id=sa;Password=123456; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categorium>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CB1D97FF6");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F2D0361EE");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4836862FC24");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107DD968D54");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EA3B74E5C");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132BC8C161E");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B3D32710");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D866083539");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE5C5847AC");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6D06D8F24");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C8F7BD1B");
